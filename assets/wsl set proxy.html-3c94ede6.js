import{_ as e,W as t,X as l,Y as s,Z as n,$ as p,a0 as i,E as o}from"./framework-1046fca1.js";const c={},r=i(`<h1 id="wsl2-set-network-proxy-in-win11" tabindex="-1"><a class="header-anchor" href="#wsl2-set-network-proxy-in-win11" aria-hidden="true">#</a> wsl2 set network proxy in win11</h1><h2 id="脚本" tabindex="-1"><a class="header-anchor" href="#脚本" aria-hidden="true">#</a> 脚本</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/sh</span>
