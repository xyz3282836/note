import{_ as s,W as n,X as a,Y as e}from"./framework-7d39e0da.js";const c={},t=e(`<h1 id="mysql-字符集" tabindex="-1"><a class="header-anchor" href="#mysql-字符集" aria-hidden="true">#</a> mysql 字符集</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>mysql<span class="token operator">&gt;</span> SHOW VARIABLES LIKE <span class="token string">&#39;character_set_client&#39;</span><span class="token punctuation">;</span>
+----------------------+---------+
