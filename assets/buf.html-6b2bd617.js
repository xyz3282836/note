...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,5);function m(k,g){const s=o("ExternalLinkIcon");return l(),u("div",null,[p,n("p",null,[n("a",d,[e("https://buf.build/docs/tutorials/getting-started-with-buf-cli"),t(s)])]),r,n("p",null,[n("a",v,[e("https://buf.build/docs/tutorials/getting-started-with-bsr"),t(s)])]),b])}const f=i(c,[["render",m],["__file","buf.html.vue"]]);export{f as default};
