import{_ as n,W as s,X as a,a0 as t}from"./framework-52f8fb67.js";const e={},p=t(`<h1 id="pool池" tabindex="-1"><a class="header-anchor" href="#pool池" aria-hidden="true">#</a> pool池</h1><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// A Pool must not be copied after first use.</span>
