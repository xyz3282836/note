import{_ as i,W as l,X as u,Z as n,$ as e,a0 as t,Y as a,C as o}from"./framework-2fbbe1ff.js";const p={},c=a(`<h2 id="前置安装" tabindex="-1"><a class="header-anchor" href="#前置安装" aria-hidden="true">#</a> 前置安装</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>brew install bufbuild/buf/buf
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,5);function m(k,g){const s=o("ExternalLinkIcon");return l(),u("div",null,[c,n("p",null,[n("a",d,[e("https://buf.build/docs/tutorials/getting-started-with-buf-cli"),t(s)])]),r,n("p",null,[n("a",v,[e("https://buf.build/docs/tutorials/getting-started-with-bsr"),t(s)])]),b])}const f=i(p,[["render",m],["__file","buf.html.vue"]]);export{f as default};
