...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>root 根节点不放数据，外部无法获取 root 节点信息</p><p>使用上非环，内部实现其实是环</p><h2 id="ring" tabindex="-1"><a class="header-anchor" href="#ring" aria-hidden="true">#</a> ring</h2><p>operations on circular lists</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> Ring <span class="token keyword">struct</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>双向链表，环</p><p>可 unlink，link，move，do</p><h2 id="heap" tabindex="-1"><a class="header-anchor" href="#heap" aria-hidden="true">#</a> heap</h2><p>包含 sort.Interface: Less() Len() Swap() ,加上自己的 interface: Pop(),Push()</p>`,13),l=[i];function o(c,r){return e(),s("div",null,l)}const u=n(t,[["render",o],["__file","container.html.vue"]]);export{u as default};
