import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as u,c as o,b as n,d as e,e as t,a}from"./app-08e26ff4.js";const p={},c=a(`<h2 id="前置安装" tabindex="-1"><a class="header-anchor" href="#前置安装" aria-hidden="true">#</a> 前置安装</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>brew install bufbuild/buf/buf
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="bufcli" tabindex="-1"><a class="header-anchor" href="#bufcli" aria-hidden="true">#</a> BufCli</h2>`,3),d={href:"https://buf.build/docs/tutorials/getting-started-with-buf-cli",target:"_blank",rel:"noopener noreferrer"},r=a(`<p>在 proto 目录下，创建<code>buf.yaml</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>buf mod init // proto目录执行
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,5);function m(k,g){const s=l("ExternalLinkIcon");return u(),o("div",null,[c,n("p",null,[n("a",d,[e("https://buf.build/docs/tutorials/getting-started-with-buf-cli"),t(s)])]),r,n("p",null,[n("a",v,[e("https://buf.build/docs/tutorials/getting-started-with-bsr"),t(s)])]),b])}const y=i(p,[["render",m],["__file","buf.html.vue"]]);export{y as default};
