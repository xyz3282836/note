import{_ as i,W as n,X as e,Y as l}from"./framework-7d39e0da.js";const d={},s=l(`<h1 id="go-tool-compile" tabindex="-1"><a class="header-anchor" href="#go-tool-compile" aria-hidden="true">#</a> go tool compile</h1><h3 id="命令行" tabindex="-1"><a class="header-anchor" href="#命令行" aria-hidden="true">#</a> 命令行</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>go tool compile [flags] file...
