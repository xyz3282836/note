import{_ as e,X as n,Y as s,Z as a}from"./framework-5a8052d6.js";const i={},d=a(`<h1 id="du" tabindex="-1"><a class="header-anchor" href="#du" aria-hidden="true">#</a> du</h1><p>参数</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>-h, --human-readable
    以K，M，G为单位，显示文件的大小
...
354M    ./room-service
355M    <span class="token builtin class-name">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),l=[d];function r(c,v){return n(),s("div",null,l)}const m=e(i,[["render",r],["__file","du.html.vue"]]);export{m as default};
