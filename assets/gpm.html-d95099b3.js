...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="reference" tabindex="-1"><a class="header-anchor" href="#reference" aria-hidden="true">#</a> reference</h2>`,50),q={href:"https://mp.weixin.qq.com/s/jIWe3nMP6yiuXeBQgmePDg",target:"_blank",rel:"noopener noreferrer"};function S(P,C){const t=i("RouterLink"),c=i("ExternalLinkIcon");return p(),d("div",null,[g,n("ol",null,[h,n("li",null,[s("sched.sp：保存 CPU 的 rsp 寄存器的值，指向函数调用栈栈顶，参考"),a(t,{to:"/go/asm/plan9.html"},{default:l(()=>[s("go plan9 汇编")]),_:1})]),f,y,w]),x,n("p",null,[s("与之对于的"),_,s("，可以唤醒 g，从 waiting 状态变成 runnable 状态，典型场景是 g1 读唤醒写的 g2（这个 g2 写一个满 chan 情况下），g3 写唤醒 g4（这个 g4 度一空 chan 情况下），唤醒的目标 g 优先被当前 g 所在的 p 放入本地队列中，参考"),a(t,{to:"/source-code/go-standard-lib/channel/chan.html"},{default:l(()=>[s("channel 源码解读")]),_:1})]),G,n("p",null,[n("a",q,[s("https://mp.weixin.qq.com/s/jIWe3nMP6yiuXeBQgmePDg"),a(c)])])])}const M=o(b,[["render",S],["__file","gpm.html.vue"]]);export{M as default};
