import{_ as n,X as i,Y as e,Z as s}from"./framework-418c825b.js";const l={},d=s(`<h1 id="相关命令" tabindex="-1"><a class="header-anchor" href="#相关命令" aria-hidden="true">#</a> 相关命令</h1><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">go</span> run <span class="token operator">-</span>gcfalgs <span class="token char">&#39;-m -l&#39;</span> main<span class="token punctuation">.</span><span class="token keyword">go</span>
