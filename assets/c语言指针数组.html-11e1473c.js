import{_ as n,X as s,Y as a,Z as p}from"./framework-418c825b.js";const t={},e=p(`<h1 id="c-语言指针数组" tabindex="-1"><a class="header-anchor" href="#c-语言指针数组" aria-hidden="true">#</a> c 语言指针数组</h1><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token keyword">int</span> a <span class="token operator">=</span> <span class="token number">3</span><span class="token punctuation">;</span>
