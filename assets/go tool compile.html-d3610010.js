import{_ as i,X as n,Y as e,Z as l}from"./framework-418c825b.js";const d={},s=l(`<h1 id="go-tool-compile" tabindex="-1"><a class="header-anchor" href="#go-tool-compile" aria-hidden="true">#</a> go tool compile</h1><h3 id="命令行" tabindex="-1"><a class="header-anchor" href="#命令行" aria-hidden="true">#</a> 命令行</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>go tool compile [flags] file...
