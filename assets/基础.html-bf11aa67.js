import{_ as e,V as a,W as n,$ as s}from"./framework-7d796c00.js";const i="/assets/asm1-cde16e77.png",d={},l=s(`<h1 id="基础" tabindex="-1"><a class="header-anchor" href="#基础" aria-hidden="true">#</a> 基础</h1><h2 id="汇编程序指令-assembler-directives" tabindex="-1"><a class="header-anchor" href="#汇编程序指令-assembler-directives" aria-hidden="true">#</a> 汇编程序指令 assembler directives</h2><h3 id="data" tabindex="-1"><a class="header-anchor" href="#data" aria-hidden="true">#</a> DATA</h3><p>DATA symbol + offset(SB)/width, value</p><p>在给定的 offset 和 width 处初始化该符号的内存为 value。 DATA 必须使用增加的偏移量来写入给定符号的指令。</p><div class="language-asm line-numbers-mode" data-ext="asm"><pre class="language-asm"><code>DATA divtab&lt;&gt;+0x00(SB)/4, $0xf4f8fcff
