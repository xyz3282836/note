import{_ as n,W as s,X as a,Y as t}from"./framework-7d39e0da.js";const e={},p=t(`<h1 id="pool-池" tabindex="-1"><a class="header-anchor" href="#pool-池" aria-hidden="true">#</a> pool 池</h1><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// A Pool must not be copied after first use.</span>
