import{_ as n,X as s,Y as a,Z as t}from"./framework-418c825b.js";const e={},p=t(`<h1 id="pool-池" tabindex="-1"><a class="header-anchor" href="#pool-池" aria-hidden="true">#</a> pool 池</h1><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// A Pool must not be copied after first use.</span>
